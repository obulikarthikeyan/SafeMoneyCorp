    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html" style="font-size:24px;color:#5E5E5E"><strong>SafeMoneyCorp</strong></a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="<%= request.getContextPath() %>/external/displayExternalUserDetails"><i class="fa fa-edit fa-fw"></i> Manage Account</a>
                        </li>
                        <li>
