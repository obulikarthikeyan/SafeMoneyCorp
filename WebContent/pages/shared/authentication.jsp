...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
				...
				<input id="j_password" name="j_password"  type="password" class="form-control" style="position:absolute;width:200px;left:400px;top:300px;z-index:2" placeholder="Password" maxlength="30"/>
