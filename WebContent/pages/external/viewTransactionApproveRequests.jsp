...
<title>SafeMoneyCorp - Approve Transaction Requests</title>
</head>
<body>
	...
	<div id="page-wrapper">
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Transaction Requests List</h1>
			</div>
			<!-- /.col-lg-12 -->
		</div>
		<!-- /.row -->
			...
			<div class="panel panel-default">
				...
				<br>
							...
							<table class="table" style="width: 120%">
								...
								<tbody>
									<c:if test="${not empty viewTransactionRequestList}">
										<c:forEach var="request" items="${viewTransactionRequestList}" varStatus="status">
											<tr>
												...
												<c:if test="${request.status == 'NEW' }">
													<td><form method="POST" action="approveViewUserTransactions">
													...
													<td><form method="POST" action="declineViewUserTransactions">
													<input type="hidden" value="${request.requestId }" name="requestId">
