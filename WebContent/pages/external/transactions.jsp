						...
						<div class="panel panel-default">
							...
							<div class="panel-body" >
								...
								<ul class="nav nav-pills">
									<li class="active"><a href="#Summary" data-toggle="tab">Account Summary</a>
									</li>
									...
									<li><a href="#Authorize" data-toggle="tab">Authorize Payment</a>
									</li>
									<li><a href="#Initiate" data-toggle="tab">Initiate Payment</a>
									</li>
